document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    // _cc sempre inclui gestora + substituto (se informado)
    var emailSubstituto = document.getElementById('emailSubstituto').value.trim();
    var ccInput = document.getElementById('cc');
    let ccList = ['marianaboccanerapediatra@gmail.com'];
    if (emailSubstituto) ccList.unshift(emailSubstituto);
    ccInput.value = ccList.join(',');

    var nextInput = document.getElementById('next');
    nextInput.value = "https://keisystellacarvalho.github.io/trocas-plantao/thanks.html";
  });
